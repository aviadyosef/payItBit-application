...
class WalletResourceIT {
    ...
    private static final WalletType DEFAULT_WALLET_TYPE = WalletType.BTC;
    private static final WalletType UPDATED_WALLET_TYPE = WalletType.USDT;
    ...
    public static Wallet createEntity(EntityManager em) {
        Wallet wallet = new Wallet().readableName(DEFAULT_READABLE_NAME).walletType(DEFAULT_WALLET_TYPE);
        return wallet;
    }
    ...
    public static Wallet createUpdatedEntity(EntityManager em) {
        Wallet wallet = new Wallet().readableName(UPDATED_READABLE_NAME).walletType(UPDATED_WALLET_TYPE);
        return wallet;
    }
    ...
    void putNewWallet() throws Exception {
        ...
        updatedWallet.readableName(UPDATED_READABLE_NAME).walletType(UPDATED_WALLET_TYPE);
    ...
    void partialUpdateWalletWithPatch() throws Exception {
        ...
        partialUpdatedWallet.readableName(UPDATED_READABLE_NAME).walletType(UPDATED_WALLET_TYPE);
