...
import com.ay.payitbit.domain.Customer;
import com.ay.payitbit.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getSeqNo()).isEqualTo(DEFAULT_SEQ_NO);
        ...
        assertThat(testCustomer.getTelegramName()).isEqualTo(DEFAULT_TELEGRAM_NAME);
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getSeqNo()).isEqualTo(UPDATED_SEQ_NO);
        ...
        assertThat(testCustomer.getTelegramName()).isEqualTo(UPDATED_TELEGRAM_NAME);
    }
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.seqNo(UPDATED_SEQ_NO).email(UPDATED_EMAIL).telegramName(UPDATED_TELEGRAM_NAME);
