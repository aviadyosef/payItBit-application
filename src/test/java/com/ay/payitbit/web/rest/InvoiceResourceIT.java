...
class InvoiceResourceIT {
    ...
    private static final String DEFAULT_SEQ_NO = "AAAAAAAAAA";
    private static final String UPDATED_SEQ_NO = "BBBBBBBBBB";
    ...
    void createInvoice() throws Exception {
        ...
        assertThat(testInvoice.getSeqNo()).isEqualTo(DEFAULT_SEQ_NO);
        ...
        assertThat(testInvoice.getAction()).isEqualTo(DEFAULT_ACTION);
    }
    ...
    void putNewInvoice() throws Exception {
        ...
        Invoice testInvoice = invoiceList.get(invoiceList.size() - 1);
        assertThat(testInvoice.getSeqNo()).isEqualTo(UPDATED_SEQ_NO);
        ...
        assertThat(testInvoice.getAction()).isEqualTo(UPDATED_ACTION);
    }
    ...
    void partialUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.invoiceNumber(UPDATED_INVOICE_NUMBER).companyName(UPDATED_COMPANY_NAME).createdBy(UPDATED_CREATED_BY);
