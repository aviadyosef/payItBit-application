...
public class Transaction implements Serializable {
    ...
    public UserInfo getTransaction() {
        return this.transaction;
    }

    public Transaction transaction(UserInfo userInfo) {
        this.setTransaction(userInfo);
        return this;
    }

    public void setTransaction(UserInfo userInfo) {
