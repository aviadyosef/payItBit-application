...
/**
 * REST controller for managing {@link com.ay.payitbit.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CustomerResource {
    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        Optional<Customer> result = customerRepository
            ...
            .map(
                existingCustomer -> {
                    if (customer.getSeqNo() != null) {
                        existingCustomer.setSeqNo(customer.getSeqNo());
                    }
                    ...
                    if (customer.getTelegramName() != null) {
                        existingCustomer.setTelegramName(customer.getTelegramName());
                    }
