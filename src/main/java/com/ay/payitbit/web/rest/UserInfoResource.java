...
/**
 * REST controller for managing {@link com.ay.payitbit.domain.UserInfo}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class UserInfoResource {
    ...
    public ResponseEntity<UserInfo> partialUpdateUserInfo(
        ...
        Optional<UserInfo> result = userInfoRepository
            ...
            .map(
                existingUserInfo -> {
                    if (userInfo.getSeqNo() != null) {
                        existingUserInfo.setSeqNo(userInfo.getSeqNo());
                    }
                    if (userInfo.getCreatedOn() != null) {
                        existingUserInfo.setCreatedOn(userInfo.getCreatedOn());
                    }
                    ...
                    if (userInfo.getCompanyName() != null) {
                        existingUserInfo.setCompanyName(userInfo.getCompanyName());
                    }
                    if (userInfo.getTelegramName() != null) {
                        existingUserInfo.setTelegramName(userInfo.getTelegramName());
                    }
