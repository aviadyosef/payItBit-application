...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVOICEINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVOICEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVOICEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVOICEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVOICEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVOICEINFO actions', async () => {
      const expectedActions = [
        {
