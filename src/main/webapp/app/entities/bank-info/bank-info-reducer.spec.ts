...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bank-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKINFO actions', async () => {
      const expectedActions = [
        {
