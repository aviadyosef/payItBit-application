...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPLIERINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUPPLIERINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUPPLIERINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUPPLIERINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUPPLIERINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUPPLIERINFO actions', async () => {
      const expectedActions = [
        {
