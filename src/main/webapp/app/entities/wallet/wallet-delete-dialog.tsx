...
export const WalletDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="payItBitApplicationApp.wallet.delete.question">Are you sure you want to delete this Wallet?</ModalBody>
      <ModalFooter>
