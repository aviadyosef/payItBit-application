...
export const WalletUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const saveEntity = values => {
    const entity = {
      ...walletEntity,
      ...values,
      wallet: customers.find(it => it.id.toString() === values.walletId.toString()),
    };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Wallte Type" id="wallet-wallteType" name="wallteType" data-cy="wallteType" type="select">
                <option value="BTC">BTC</option>
                <option value="USDT">USDT</option>
              </ValidatedField>
              <ValidatedField label="Id Wallet" id="wallet-idWallet" name="idWallet" data-cy="idWallet" type="text" />
