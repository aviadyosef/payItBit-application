          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Invoice Info <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  Supplier Info <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  Bank Info <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {invoiceList.map((invoice, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{invoice.seqNo}</td>
                  <td>{invoice.createdOn ? <TextFormat type="date" value={invoice.createdOn} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{invoice.createdBy}</td>
                  <td>{invoice.action}</td>
                  <td>{invoice.invoiceInfo ? <Link to={`invoice-info/${invoice.invoiceInfo.id}`}>{invoice.invoiceInfo.id}</Link> : ''}</td>
                  <td>
                    {invoice.supplierInfo ? <Link to={`supplier-info/${invoice.supplierInfo.id}`}>{invoice.supplierInfo.id}</Link> : ''}
                  </td>
                  <td>{invoice.bankInfo ? <Link to={`bank-info/${invoice.bankInfo.id}`}>{invoice.bankInfo.id}</Link> : ''}</td>
                  <td>{invoice.invoice ? <Link to={`user-info/${invoice.invoice.id}`}>{invoice.invoice.id}</Link> : ''}</td>
